<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="VCTDashboardStep3.aspx.cs" Inherits="VCTWebApp.VCTDashboardStep3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1>Traceback & Trace forward from FG Serial No.
        </h1>
        <ol class="breadcrumb">
            <li>
            ...
            <li><a href="#">Traceback & Trace forward from FG Serial No.</a></li>
        </ol>
    </section>
    <div class="col-xs-12">
        <div class="box">
                    ...
                    <div id="DivShow" runat="server" visible="false" autopostback="true">
                        ...
                        <div id="DivGrid" runat="server" style="overflow: auto; width: 100%;">
                            ...
                            <asp:GridView ID="gvUserMaster" runat="server" FooterStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center"
                                ...
                                OnRowCommand="gvVCTDashboard_RowCommand">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Production Date" DataField="Date" HeaderStyle-HorizontalAlign="Left"
                                        ItemStyle-HorizontalAlign="Left">
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:BoundField>

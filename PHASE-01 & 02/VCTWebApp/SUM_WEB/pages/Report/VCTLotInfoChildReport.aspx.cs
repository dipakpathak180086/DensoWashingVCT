...
namespace VCTWebApp
{
    public partial class VCTLotInfoChildReport : System.Web.UI.Page
    {
        ...
        private void _PopulateModel()
        {
            try
            {
                PL_LOT_INFO_CHILD_ASSY_REPORT plObj = new PL_LOT_INFO_CHILD_ASSY_REPORT();
                BL_LOT_INFO_CHILD_ASSY_REPORT blObj = new BL_LOT_INFO_CHILD_ASSY_REPORT();

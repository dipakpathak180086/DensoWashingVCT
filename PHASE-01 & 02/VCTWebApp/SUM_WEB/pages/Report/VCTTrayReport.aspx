<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="VCTTrayReport.aspx.cs" Inherits="VCTWebApp.VCTTrayReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1>Line Washing Tray Records Report
        </h1>
        <ol class="breadcrumb">
            <li>
            ...
            <li><a href="#">Line Washing Tray Records Report</a></li>
        </ol>
    </section>
    <div class="col-xs-12">
        <div class="box">
                    ...
                    <div id="DivEntry" runat="server" class="box-header">
                        ...
                        <table id="tblentry" runat="server" class="table" style="width: 95%; margin-left: 0%; margin-right: 5%;"
                            ...
                            <tr>
                                ...
                                <td style="text-align: right; width: 200px">Enter Tray <span style="color: Red;"></span>
                                </td>
                                <td style="text-align: center; width: 10px">:
                                    
                                </td>
                                <td style="text-align: left; width: 200px">
                                    <asp:TextBox autocomplete="off" ID="txtTray" class="form-control" runat="server" ToolTip="Enter Tray" placeholder="Enter Tray"
    ...
    <%--<div style="font-weight: bold">
        :
                    ...
                    <div id="DivShow" runat="server" visible="false" autopostback="true">
                        ...
                        <div id="DivGrid" runat="server" style="overflow: auto; width: 100%;">
                            ...
                            <asp:GridView ID="gvUserMaster" runat="server" FooterStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center"
                                ...
                                <Columns>
                                    <asp:BoundField HeaderText="Tray ID" DataField="TrayBarcode" HeaderStyle-HorizontalAlign="Left"
                ...
                <Triggers>
                    ...
                    <asp:PostBackTrigger ControlID="txtTray" />
    ...
    $('#ContentPlaceHolder1_txtFromDate').datetimepicker({
        ...
        onSelectDate: function (ct) {
            // Selected From Date
            var fromDate = new Date(ct);

            // +7 days
            var toDate = new Date(ct);
            toDate.setDate(toDate.getDate() + 7);

            // Update ToDate picker
            $('#ContentPlaceHolder1_txtToDate').val('');
            $('#ContentPlaceHolder1_txtToDate').datetimepicker('destroy'); // reset first
            ...
            // Auto-fill ToDate = FromDate + 7 days
            $('#ContentPlaceHolder1_txtToDate').val($.datetimepicker.formatDate('Y-m-d', toDate));
        }
    });

                    ...
                    while (!_sr.EndOfStream)
                    {
                        ...
                        switch (_strArr[0])
                        {
                            ...
                            case "SQL_DB_PASSWORD":
                                ...
                                break;
                            case "KIT-COM-PORT":
                                GlobalVariable.mKitScannerPort = _strArr[1].ToString().Trim();
                                break;
                            case "KIT-BAUD-RATE":
                                GlobalVariable.mKitScannerBaudRate = _strArr[1].ToString().Trim();
                                break;
                            case "KIT-DATA-BITS":
                                GlobalVariable.mKitScannerDataBits = _strArr[1].ToString().Trim();
                                break;
                            case "KIT-PARITY":
                                GlobalVariable.mKitScannerParity = _strArr[1].ToString().Trim();
                                break;
                            case "KIT-STOP-BITS":

...
{
    public partial class frmConveyorLinePCMappingMaster : Form
    {


        #region Variables

        private BL_CONVEYOR_LINE_PC_MAPPING_MASTER _blObj = null;
        private PL_CONVEYOR_LINE_PC_MAPPING_MASTER _plObj = null;
        ...
        public frmConveyorLinePCMappingMaster()
        {
            try
            {
                InitializeComponent();
                _blObj = new BL_CONVEYOR_LINE_PC_MAPPING_MASTER();
            }
            catch (Exception ex)
            {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                if (ValidateInput())
                {
                    _plObj = new PL_CONVEYOR_LINE_PC_MAPPING_MASTER();
                    _plObj.RowId = _iRowId;
                    _plObj.LinePc = txtLinePC.Text.ToString().Trim();
        ...
        private void BindConveyor()
        {
            try
            {
                PL_CONVEYOR_LINE_PC_MAPPING_MASTER plObj = new PL_CONVEYOR_LINE_PC_MAPPING_MASTER();
        ...
        private void dgv_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                cmbConveyor.SelectedValue= dgv.Rows[e.RowIndex].Cells["ConveryorCode"].Value.ToString();
                txtLinePC.Text = dgv.Rows[e.RowIndex].Cells["LinePC"].Value.ToString();
